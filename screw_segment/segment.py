...
class SegmentationPipeline:
    ...
    def process_image(self, img_path):
        ...
        for inst_id, det in enumerate(detections, start=1):
            bbox = det['box']
            mask = self.segmentor.segment_in_bbox(image, bbox)
...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='./output',
                        help='输出目录')
    parser.add_argument('--weights', type=str, default='../screw_count/weights/best.pt',
                        help='YOLO 检测模型权重路径')
